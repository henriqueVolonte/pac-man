# codigo para comversar entre tela inicial e tela do jogo
import os
import sprites
import constantes
import pygame
...
# Variáveis e funções da tela principal


def iniciar_jogo():
    # Aqui você chama a função para iniciar o jogo
    pass
...
class Game:
    ...
    def carregar_arquivos(self):
        ...
        self.spritesheet = os.path.join(
            diretorio_imagens, constantes.SPRITESHEET)
        self.pacman_start_logo = os.path.join(
            diretorio_imagens, constantes.PACMAN_START_LOGO)
        self.pacman_start_logo = pygame.image.load(
            self.pacman_start_logo).convert()
    ...
    def mostrar_tela_start(self):
        pygame.mixer.music.load(os.path.join(
            self.diretorio_audios, constantes.MUSICA_START))
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYUP:
                    ...
                    pygame.mixer.Sound(os.path.join(
                        self.diretorio_audios, constantes.TECLA_START)).play()
